...
const INITIAL_NOTIFS: Notif[] = [
  ...
  },
  {
    id: 'n-p2',
    type: 'debit-paiement',
    titre: 'Débit automatique effectué — CBAO',
    description: 'Prélèvement de 208 400 FCFA sur votre compte CBAO Attijariwafa Bank ****4721 le 22 juillet 2026 à 09h00.',
    date: "Aujourd'hui",
    heure: '09:00',
    lu: false,
    category: 'paiements',
  ...
  },
  {
    ...
    description: 'Votre dossier de financement (réf. CPI-2026-04721) a été transmis à CBAO Attijariwafa Bank pour instruction. Vous serez notifié dès que la banque rend sa décision.',
    date: '10 juin 2026',
    heure: '09:00',
    lu: true,
    category: 'dossier',
