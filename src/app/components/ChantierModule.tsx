                ...
                <div style={{ padding: '16px 18px', borderBottom: '1px solid var(--border)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                    ...
                    <button
                      onClick={() => {
                        if (!isCh1) return;
                        addMedia({ type: 'photo', titre: `Photo chantier ${new Date().toLocaleDateString('fr-FR', { day: '2-digit', month: 'short' })}`, description: '', phase: 2, auteur: agentName, url: '', bg: 'linear-gradient(135deg,#1A3A6E,#2E6EC4)', visibleClient: true }, agentName);
